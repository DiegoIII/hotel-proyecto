  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Button variant="primary" onClick={handleShow}>Agregar Tipo</Button>
      </div>
      <table className="table table-striped">
        ...
        <tbody>
          {/* Aquí irán los datos de tipos de habitación en el futuro */}
        </tbody>
      </table>

      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Agregar Tipo de Habitación</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            {campos.map((campo) => (
